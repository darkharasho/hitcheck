...
| `app/src/overlay/overlay.html` | Overlay renderer document |
...
**Files:**
- Create: `app/src/main/overlay/window.ts`, `app/src/overlay/overlay.html`
...
export function createOverlayWindow(bounds: Rect): BrowserWindow {
  ...
  overlay.loadFile(join(import.meta.dirname, '../overlay/overlay.html'))
